...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.D, request.H, true);
		} catch (e) {
...
var $author$project$Route$RLogin = 0;
...
var $author$project$Route$RHome = 1;
var $author$project$Route$RHops = 2;
var $author$project$Route$RReferentials = 4;
var $author$project$Route$RUpload = 3;
	...
	_List_fromArray(
		[
			...
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('admin'),
				$elm$url$Url$Parser$s('referentials')))
		]));
...
var $author$project$Route$href = function (route) {
	switch (route) {
		...
		case 3:
			return '/admin/upload';
		default:
			return '/admin/referentials';
	}
};
var $author$project$Pages$Login$init = function (csrf) {
	return {s: false, y: csrf, aO: '', K: $elm$core$Maybe$Nothing, aW: ''};
};
		...
		return _Utils_Tuple2(
			{
				...
				M: key,
				P: $author$project$Pages$Login$init(flags.y),
				Q: route,
			...
			((!flags.j) && (!(!rawRoute))) ? A2(
				...
				key,
				$author$project$Route$href(0)) : $elm$core$Platform$Cmd$none);
	});
...
var $author$project$Main$HopsMsg = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Pages$Hops$httpErrorToString = function (err) {
	switch (err.$) {
		case 0:
			return 'URL invalide';
		case 1:
		...
		case 3:
			var code = err.a;
			return 'Erreur serveur (' + ($elm$core$String$fromInt(code) + ')');
		default:
			return 'Réponse illisible';
	}
};
var $author$project$Pages$Hops$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var hs = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{K: $elm$core$Maybe$Nothing, L: hs, O: false}),
				...
				_Utils_update(
					model,
					{
						K: $elm$core$Maybe$Just(
							$author$project$Pages$Hops$httpErrorToString(e)),
						O: false
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Pages$Login$GotLogin = function (a) {
	return {$: 3, a: a};
};
var $author$project$Pages$Login$httpErrorToString = function (err) {
	switch (err.$) {
		case 0:
			return 'URL invalide';
		case 1:
		...
		case 3:
			var code = err.a;
			return (code === 401) ? 'Identifiants invalides' : ('Erreur (' + ($elm$core$String$fromInt(code) + ')'));
		default:
			return 'Réponse illisible';
	}
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aJ: false, x: r.x, B: r.B, C: r.C, D: r.D, F: r.F, G: r.G, H: r.H}));
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Api$tokenDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
...
var $author$project$Api$withCsrfHeaders = function (maybeToken) {
	if (!maybeToken.$) {
		var t = maybeToken.a;
		return _List_fromArray(
			[
				A2($elm$http$Http$header, 'Csrf-Token', t)
			]);
	} else {
		return _List_Nil;
	}
...
var $author$project$Api$login = F3(
	function (creds, csrf, onResult) {
		return $elm$http$Http$request(
			{
				x: $elm$http$Http$jsonBody(
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'email',
								$elm$json$Json$Encode$string(creds.aO)),
								_Utils_Tuple2(
								'password',
								$elm$json$Json$Encode$string(creds.aW))
							]))),
				B: A2($elm$http$Http$expectJson, onResult, $author$project$Api$tokenDecoder),
				C: $author$project$Api$withCsrfHeaders(csrf),
				D: 'POST',
		...
		switch (msg.$) {
			...
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{s: true, K: $elm$core$Maybe$Nothing}),
					A3(
						$author$project$Api$login,
						{aO: model.aO, aW: model.aW},
						model.y,
						$author$project$Pages$Login$GotLogin));
			default:
				if (!msg.a.$) {
					return _Utils_Tuple2(
						_Utils_update(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								s: false,
								K: $elm$core$Maybe$Just(
									$author$project$Pages$Login$httpErrorToString(e))
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
	});
var $author$project$Pages$Upload$GotUpload = function (a) {
	return {$: 3, a: a};
};
var $author$project$Pages$Upload$Picked = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Pages$Upload$httpErrorToString = function (err) {
	switch (err.$) {
		case 0:
			return 'URL invalide';
		case 1:
...
var $author$project$Api$expectUnit = function (toMsg) {
	return A2(
		$elm$http$Http$expectStringResponse,
		toMsg,
		function (response) {
...
var $author$project$Api$uploadHopsCsvFile = F3(
	function (file, csrf, onResult) {
		return $elm$http$Http$request(
			{
				x: $elm$http$Http$fileBody(file),
				B: $author$project$Api$expectUnit(onResult),
				C: $author$project$Api$withCsrfHeaders(csrf),
				D: 'POST',
				F: $elm$core$Maybe$Nothing,
				G: $elm$core$Maybe$Nothing,
				H: '/api/admin/hops/upload'
			});
	});
			...
			case 0:
				return _Utils_Tuple2(
					...
					A2(
						...
						_List_fromArray(
							['text/csv', '.csv']),
						$author$project$Pages$Upload$Picked));
			case 1:
				var file = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
				...
				if (_v1.$ === 1) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								K: $elm$core$Maybe$Just('Veuillez choisir un fichier CSV.')
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var f = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{s: true, z: false, K: $elm$core$Maybe$Nothing}),
						A3($author$project$Api$uploadHopsCsvFile, f, model.y, $author$project$Pages$Upload$GotUpload));
				}
			default:
				if (!msg.a.$) {
					return _Utils_Tuple2(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								s: false,
								K: $elm$core$Maybe$Just(
									$author$project$Pages$Upload$httpErrorToString(e))
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
		...
		switch (msg.$) {
			case 1:
				...
				if (!req.$) {
					...
					var next = A2(
						...
						0,
						$author$project$Route$fromUrl(url));
					return ((!model.j) && (!(!next))) ? _Utils_Tuple2(
						model,
						A2(
							$elm$browser$Browser$Navigation$replaceUrl,
							model.M,
							$author$project$Route$href(0))) : _Utils_Tuple2(
						model,
						A2(
							$elm$browser$Browser$Navigation$pushUrl,
							model.M,
			...
			case 0:
				...
				var r = A2(
					...
					0,
					$author$project$Route$fromUrl(url));
				return ((!model.j) && (!(!r))) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{Q: 0}),
			...
			case 2:
				var sub = msg.a;
				var _v2 = A3($author$project$Pages$Login$update, model.M, sub, model.P);
				var m = _v2.a;
				var cmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 3:
				...
				if (_v3.$ === 1) {
					...
					var hm = _v3.a;
					var _v4 = A2($author$project$Pages$Hops$update, sub, hm);
					var hm2 = _v4.a;
					var cmd = _v4.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								L: $elm$core$Maybe$Just(hm2)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$HopsMsg, cmd));
				}
			default:
				var sub = msg.a;
				var _v5 = model.W;
				if (_v5.$ === 1) {
					...
					var um = _v5.a;
					var _v6 = A2($author$project$Pages$Upload$update, sub, um);
					var um2 = _v6.a;
					var cmd = _v6.b;
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Main$navBar = function (isAuth) {
	return (!isAuth) ? A2($elm$html$Html$div, _List_Nil, _List_Nil) : A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Route$href(1))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Accueil admin')
					])),
				A2(
				$elm$html$Html$span,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Référentiels')
					]))
			]));
};
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Gérer les houblons')
						])),
					A2(
					$elm$html$Html$a,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Charger des données (CSV)')
						])),
					A2(
					$elm$html$Html$a,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Gérer les référentiels')
						]))
				]))
		]));
var $elm$html$Html$li = _VirtualDom_node('li');
var $elm$html$Html$ul = _VirtualDom_node('ul');
var $author$project$Pages$Hops$view = function (model) {
	if (model.O) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('Chargement des houblons…')
				]));
	} else {
		var _v0 = model.K;
		if (!_v0.$) {
...
var $author$project$Pages$Login$Submit = {$: 2};
...
var $author$project$Pages$Login$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('login-wrapper card')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						model.s ? 'Connexion…' : 'Se connecter')
					])),
				function () {
				var _v0 = model.K;
				if (_v0.$ === 1) {
...
var $author$project$Pages$Referentials$view = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Référentiels (Aromas, ...)')
				])),
			A2(
			$elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('Affiche les listes via /api/aromas (Query). Étendre au besoin.')
				]))
		]));
var $author$project$Pages$Upload$DoUpload = {$: 2};
var $author$project$Pages$Upload$Pick = {$: 0};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Upload CSV des houblons')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Sélectionnez un fichier .csv et lancez l’import.')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Choisir un fichier')
							])),
						function () {
						var _v0 = model.X;
						if (_v0.$ === 1) {
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Aucun fichier choisi')
									]));
						} else {
							var n = _v0.a;
							return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$type_('button'),
								$elm$html$Html$Events$onClick($author$project$Pages$Upload$DoUpload),
								$elm$html$Html$Attributes$disabled(
								model.s || _Utils_eq(model.R, $elm$core$Maybe$Nothing))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								model.s ? 'Import…' : 'Importer')
							]))
					])),
				function () {
				var _v1 = model.K;
				if (!_v1.$) {
					...
					return model.z ? A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Import réussi')
							])) : $elm$html$Html$text('');
				}
			}()
			]));
...
var $author$project$Main$view = function (model) {
	return {
		x: _List_fromArray(
			[
				$author$project$Main$navBar(model.j),
				function () {
				var _v0 = model.Q;
				switch (_v0) {
					case 0:
						return A2(
							...
							$author$project$Pages$Login$view(model.P));
					case 1:
					...
					case 2:
						...
						if (_v1.$ === 1) {
							...
							return A2(
								$elm$html$Html$map,
								$author$project$Main$HopsMsg,
								$author$project$Pages$Hops$view(hm));
						}
					case 3:
						var _v2 = model.W;
						if (_v2.$ === 1) {
							...
							return A2(
								...
								$author$project$Pages$Upload$view(um));
						}
					default:
						return $author$project$Pages$Referentials$view;
				}
			}()
			]),
		a1: 'Admin'
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		aS: F3(
			function (flags, url, key) {
				return A3($author$project$Main$init, flags, url, key);
			}),
		aT: $author$project$Main$UrlChanged,
		aU: $author$project$Main$LinkClicked,
		a0: function (_v0) {
	...
	A2(
		...
		function (csrf) {
			return A2(
				...
				A2($elm$json$Json$Decode$field, 'auth', $elm$json$Json$Decode$bool));
		},
		A2(
